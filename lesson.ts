...
import { RegisterEventFunction, CancelBookedLessonFunction, CancelBookedEventFunction, GetScheduleFunction, IsCustomerFunction, RegisterLessonFunction } from "./functions";
import 'dotenv/config';

const mcpFunctions: Array<McpFunction> = [
    new GetScheduleFunction(), new IsCustomerFunction(), new RegisterLessonFunction(), 
    new CancelBookedEventFunction(), new RegisterEventFunction(), new CancelBookedEventFunction()
];
