export class RegisterEventFunction {
    constructor() {
        this.name = "registerEvent";
        this.description = "Register a customer for one of the events given at Home of Zen." +
    ...
    async handleExecution(request) {
        ...
        const result = await this.registerLesson(eventDate, eventId, customerName, email, phone);
        return result;
    }
    async registerLesson(eventDate, eventId, name, email, phone) {
